...
describe("Vigenere cipher", () => {
  ...
  describe("base requirements", () => {
    ...
    test("base encryption", () => {
      ...
      assert.strictEqual(directMachine.encrypt("Example of sequence: 1, 2, 3, 4.", "lilkey"), "PFLWTJP WQ CIOFMYMI: 1, 2, 3, 4.");
    ...
    test("base decryption", () => {
      ...
      assert.strictEqual(directMachine.decrypt("ICWWQAM KECEIK JVZZT EADGG!", "rollingscopes"), "ROLLING SCOPES SHOOL RULES!");
